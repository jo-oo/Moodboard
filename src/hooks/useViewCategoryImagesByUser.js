...
//to later check if user is authenticated to get to view the images
    ...
    console.log('options.selectedCategory->',options)
    ...
    const queryRef = options.fetchOnlyCurrentUser && options.selectedCategory
                        ? query
                               (collectionRef, 
                                where('user', '==', currentUser.uid),
                                where('category', '==', options.selectedCategory))
